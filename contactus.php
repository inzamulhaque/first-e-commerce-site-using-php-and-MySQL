                        ...
                        <form action="contactus.php" method="post">
                            ...
                            <div class="text-center">
                                <button type="submit" name="submit" class="btn btn-primary">
                                    <i class="fa fa-user-md"></i> Sens Massage
                                </button>
                            </div>
                        </form>
                    </div> <!--box-->
...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $senderMassaget=$_POST['massage'];

        $recevirerEmail="mdihalif@yahoo.com";
        mail($recevirerEmail,$senderName,$senderSubject,$senderMassaget,$senderEmail);
